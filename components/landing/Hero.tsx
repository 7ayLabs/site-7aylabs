...
function HeroComponent() {
  ...
  return (
    <section className="relative min-h-[100svh] w-full flex items-center justify-center overflow-hidden text-white bg-[linear-gradient(180deg,#000000_0%,#0a0a0a_40%,#000000_100%)]">
      ...
      <div
        aria-hidden
        className="absolute inset-0 z-0 pointer-events-none bg-[radial-gradient(800px_400px_at_50%_-20%,rgba(255,255,255,0.04),transparent_60%),radial-gradient(600px_300px_at_80%_20%,rgba(255,255,255,0.025),transparent_65%),radial-gradient(600px_300px_at_20%_30%,rgba(255,255,255,0.02),transparent_70%)]"
      />

      {/* Centered content */}
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-screen-xl mx-auto -translate-y-20 sm:-translate-y-10 md:-translate-y-4 lg:translate-y-0">
        {/* Logotype */}
        <motion.div
        ...
        <div className="mt-1 sm:mt-3 h-8 sm:h-9 flex items-center justify-center overflow-hidden">
